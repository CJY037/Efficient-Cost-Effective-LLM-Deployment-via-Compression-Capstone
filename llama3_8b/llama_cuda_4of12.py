# Llama 3 8B structured 4:12 pruning.
...
#
# Run multi-GPU:
#   torchrun --nproc_per_node=8 llama_cuda_4of12.py \
...
#
# Run single GPU:
#   CUDA_VISIBLE_DEVICES=0 python llama_cuda_4of12.py --max-train-samples 524288 --max-eval-samples 2048

# Single-GPU memory-safe default:
#   python llama_cuda_4of12.py --optimizer adafactor --train-scope prune-target --max-train-samples 4096 --max-eval-samples 512
...
def parse_args():
    ...
    p.add_argument("--save-dir", default="./llama3_8b_c4_4of12_cuda")
...
def main():
    ...
    enforce_masks(model, masks)
    main_print(f"Applied hard 4:12 masks: {stats}")

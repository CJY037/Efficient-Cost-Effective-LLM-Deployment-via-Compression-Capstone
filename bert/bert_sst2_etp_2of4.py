...
#
# Single GPU:
#   python bert_sst2_etp_2of4.py --num-epochs 3 --post-prune-epochs 1
#
# Multi-GPU:
#   torchrun --nproc_per_node=4 bert_sst2_etp_2of4.py --batch-size 16 --grad-accum-steps 2
...
def parse_args():
    ...
    p.add_argument("--save-dir", default="./bert_sst2_etp_2of4")
